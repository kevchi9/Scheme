...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |PROBLEMA 6|) (read-case-sensitive #t) (teachpacks ((lib "drawings.rkt" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "drawings.rkt" "installed-teachpacks")) #f)))
(define figura ; FUNZIONA SOLO CON LE POTENZE DI 2, restituisce l'immagine costruita in modo ricorsivo utilizzando la p come contatore 
  (lambda (p)
    (cond ((= p 1) L-tile)
